...
(function($PS) {
  ...
  var Data_Maybe = $PS["Data.Maybe"];                
  var setText = $foreign.setTextImpl;
...
(function($PS) {
  ...
  var map = function (fn, a) {
      var deps = [ Specular_Internal_Incremental_Node.toSomeNode(a) ];
      return Specular_Internal_Incremental_Node.create({
          compute: function (v) {
              var value_a = Specular_Internal_Incremental_Node.valueExc(a);
              return Specular_Internal_Incremental_Optional.some(fn(value_a));
          },
          dependencies: Control_Applicative.pure(Effect.applicativeEffect)(deps)
      });
  };   
...
(function($PS) {
  ...
  var functorDynamic = {
      map: function (f) {
          return function (v) {
              return Dynamic(Effect_Unsafe.unsafePerformEffect(function __do() {
                  var n = Specular_Internal_Incremental.map(f, v);
                  Specular_Internal_Incremental_Node.annotate(n, "map " + Specular_Internal_Incremental_Node.name(v));
                  return n;
              }));
          };
      }
      ...
      return function (dictMonadCleanup) {
          return function (handler) {
              return function (event) {
                  return Control_Bind.bind((dictMonadCleanup.Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadEffect)(function () {
                      return _subscribeNode(handler, event);
                  }))(function (unsub) {
                      return Control_Monad_Cleanup.onCleanup(dictMonadCleanup)(unsub);
                  });
              };
          };
      };
  ...
  var subscribeDyn_ = function (dictMonadFRP) {
      return function (handler) {
          return function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(((dictMonadFRP.MonadCleanup1()).Monad0()).Bind1())(subscribeNode(dictMonadFRP.MonadEffect0())(dictMonadFRP.MonadCleanup1())(handler)(v))(function () {
                  return Effect_Class.liftEffect(dictMonadFRP.MonadEffect0())(function __do() {
                      var currentValue = Specular_Internal_Incremental_Node.valueExc(v);
                      return Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(handler(currentValue))();
                  });
              });
          };
      };
  ...
  exports["subscribeDyn_"] = subscribeDyn_;
  exports["functorDynamic"] = functorDynamic;
  exports["monadFRP"] = monadFRP;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  ...
  var $foreign = $PS["Specular.Dom.Element"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Monoid = $PS["Data.Monoid"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect = $PS["Effect"];
  ...
  var dynText = function (strD) {
      return Control_Bind.bind(Specular_Dom_Builder.bindBuilder)(Specular_Dom_Builder["mkBuilder'"](function (env) {
          var node = Specular_Dom_Browser.createTextNode("")();
          Specular_Dom_Browser.appendChild(node)(env.parent)();
          return node;
      }))(function (node) {
          return Specular_FRP_Base.subscribeDyn_(Specular_FRP_Base.monadFRP(Specular_Dom_Builder.monadEffectBuilder)(Specular_Dom_Builder.monadCleanupBuilder))(Specular_Dom_Browser.setText(node))(strD);
      });
  };
  var class_ = function (cls) {
      return Prop(function (node, v) {
          return $foreign["_addClass"](node, cls);
      });
  };
  ...
  exports["el_"] = el_;
  exports["text"] = text;
  exports["dynText"] = dynText;
  exports["attr"] = attr;
  exports["onClick_"] = onClick_;
...
(function($PS) {
  ...
  var readCounters = function (cs) {
      return function (i) {
          return Data_Functor.map(Specular_FRP_Base.functorDynamic)((function () {
              var $2 = Data_Maybe.fromMaybe(0);
              return function ($3) {
                  return $2((function (v) {
                      return Data_Array.index(v)(i);
                  })($3));
              };
          })())(Specular_Ref.value(cs));
      };
  };
      ...
      return function (i) {
          return function (f) {
              var f$prime = function (xs) {
                  return Data_Maybe.fromMaybe([  ])(Data_Array.modifyAt(i)(f)(xs));
              };
              return Specular_Ref.modify(Effect_Class.monadEffectEffect)(cs)(f$prime);
          };
      };
  };
  var mkCounters = function (dictMonadEffect) {
      return Specular_Ref["new"](dictMonadEffect);
  };
  var main = Specular_Dom_Widget.runMainWidgetInBody(Control_Bind.bind(Specular_Dom_Builder.bindBuilder)(mkCounters(Specular_Dom_Builder.monadEffectBuilder)(Data_Array.replicate(3)(0)))(function (counters) {
      var subtractCb = function (i) {
          return modifyCounters(counters)(i)(Data_Semiring.add(Data_Semiring.semiringInt)(-1 | 0));
      };
      var addCb = function (i) {
          return modifyCounters(counters)(i)(Data_Semiring.add(Data_Semiring.semiringInt)(1));
      };
      return Control_Bind.discard(Control_Bind.discardUnit)(Specular_Dom_Builder.bindBuilder)(Specular_Dom_Element.el_("div")(Control_Bind.discard(Control_Bind.discardUnit)(Specular_Dom_Builder.bindBuilder)(Specular_Dom_Element.el("button")([ Specular_Dom_Element.class_("btn"), Specular_Dom_Element.attr("type")("button"), Specular_Dom_Element.onClick_(addCb(0)) ])(Specular_Dom_Element.text("+")))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Specular_Dom_Builder.bindBuilder)(Specular_Dom_Element.dynText(Data_Functor.map(Specular_FRP_Base.functorDynamic)(Data_Show.show(Data_Show.showInt))(readCounters(counters)(0))))(function () {
              return Specular_Dom_Element.el("button")([ Specular_Dom_Element.class_("btn"), Specular_Dom_Element.attr("type")("button"), Specular_Dom_Element.onClick_(subtractCb(0)) ])(Specular_Dom_Element.text("-"));
          });
      })))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Specular_Dom_Builder.bindBuilder)(Specular_Dom_Element.el_("div")(Control_Bind.discard(Control_Bind.discardUnit)(Specular_Dom_Builder.bindBuilder)(Specular_Dom_Element.el("button")([ Specular_Dom_Element.class_("btn"), Specular_Dom_Element.attr("type")("button"), Specular_Dom_Element.onClick_(addCb(1)) ])(Specular_Dom_Element.text("+")))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Specular_Dom_Builder.bindBuilder)(Specular_Dom_Element.dynText(Data_Functor.map(Specular_FRP_Base.functorDynamic)(Data_Show.show(Data_Show.showInt))(readCounters(counters)(1))))(function () {
                  return Specular_Dom_Element.el("button")([ Specular_Dom_Element.class_("btn"), Specular_Dom_Element.attr("type")("button"), Specular_Dom_Element.onClick_(subtractCb(1)) ])(Specular_Dom_Element.text("-"));
              });
          })))(function () {
              return Specular_Dom_Element.el_("div")(Control_Bind.discard(Control_Bind.discardUnit)(Specular_Dom_Builder.bindBuilder)(Specular_Dom_Element.el("button")([ Specular_Dom_Element.class_("btn"), Specular_Dom_Element.attr("type")("button"), Specular_Dom_Element.onClick_(addCb(2)) ])(Specular_Dom_Element.text("+")))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Specular_Dom_Builder.bindBuilder)(Specular_Dom_Element.dynText(Data_Functor.map(Specular_FRP_Base.functorDynamic)(Data_Show.show(Data_Show.showInt))(readCounters(counters)(2))))(function () {
                      return Specular_Dom_Element.el("button")([ Specular_Dom_Element.class_("btn"), Specular_Dom_Element.attr("type")("button"), Specular_Dom_Element.onClick_(subtractCb(2)) ])(Specular_Dom_Element.text("-"));
                  });
              }));
          });
      });
  }));
  exports["mkCounters"] = mkCounters;
  exports["modifyCounters"] = modifyCounters;
